    ...
    if count == 0:
        ...
        for subcategory_data in all_subcategories_data:
            ...
            if subcategory_data.ul != None:
                ...
                src = req.text
                soup = BeautifulSoup(src, "lxml")
                all_subcategory_item_data = soup.find(class_="catalog blocks active")
                subcategory_item_data = soup.find(class_="catalog blocks active").find_all("a", class_="link")
            ...
            for item in subcategory_item_data:
                ...
                product = soup.find(class_="main-data") # if ... container style2022 product-page
